...
# Analytical Methods
# -------------------------------
from methods.theis import theis_fit, theis_s
from methods.cooper_jacob import cooper_jacob_fit
from methods.neuman import neuman_fit
from methods.recovery import recovery_fit
from methods.interference import multiwell_timeseries
from methods.pump72 import simulate_72hr_test
from designer.well_designer import design_well


# -------------------------------
# FEM Model & Plotting
# -------------------------------
from fem.fd2d_solver import run_fd2d_model
from fem.plot_contours import plot_drawdown_contours
from fem.whp import compute_whp_zones
...
# Calibration Engine
# -------------------------------
from methods.calibration import calibrate_parameters

# --------------------------------------------------
# WELL DESIGN MODULES
# --------------------------------------------------
from designer.gravel_pack import design_gravel_pack
from designer.development import estimate_well_development_time
from designer.pump_selector import pump_selection
from designer.cost_estimator import estimate_well_cost, pump_energy_cost
from designer.well_diagram import make_well_diagram
